  ...
  return (
    <PaperProvider>
      <NavigationContainer>
        ...
        >
          <Stack.Screen name="Home" options={{headerShown: false}} component={HabitEmptyState} />
          <Stack.Screen name="Profile" options={{title: '', headerShown: false} } component={ProfileScreen} />
          <Stack.Screen name="EditProfile" options={{title: '', headerShown: false} }component={EditProfileScreen} />
          <Stack.Screen name="Habit" options={{headerShown: false}} component={HomeScreen} />
